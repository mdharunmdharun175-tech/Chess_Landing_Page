...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 bg-white shadow-lg shadow-blue-500/10 border-b-[3px] border-[#d4a843] reveal reveal-up ${scrolled ? 'py-0' : 'py-2'}`}
